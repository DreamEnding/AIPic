import { CURRENT_THUMBNAIL_VERSION, getImage, getImageThumbnail, getStoredFreshImageThumbnail } from '../lib/db'

export const imageCache = new Map<string, string>()

export const thumbnailCache = new Map<string, { dataUrl: string; width?: number; height?: number; thumbnailVersion?: number }>()

export const thumbnailBackfillIds = new Map<string, 'visible' | 'background'>()

export const thumbnailBackfillRunningIds = new Set<string>()

export const thumbnailSubscribers = new Map<string, Set<(thumbnail: { dataUrl: string; width?: number; height?: number }) => void>>()
